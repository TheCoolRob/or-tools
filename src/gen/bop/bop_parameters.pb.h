...
class BopOptimizerMethod : public ::google::protobuf::Message {
 public:
  BopOptimizerMethod();
  ...
  static const OptimizerType SAT_CORE_BASED = BopOptimizerMethod_OptimizerType_SAT_CORE_BASED;
  static const OptimizerType SAT_LINEAR_SEARCH = BopOptimizerMethod_OptimizerType_SAT_LINEAR_SEARCH;
  static const OptimizerType LINEAR_RELAXATION = BopOptimizerMethod_OptimizerType_LINEAR_RELAXATION;
  static const OptimizerType LOCAL_SEARCH = BopOptimizerMethod_OptimizerType_LOCAL_SEARCH;
  static const OptimizerType RANDOM_FIRST_SOLUTION = BopOptimizerMethod_OptimizerType_RANDOM_FIRST_SOLUTION;
  static const OptimizerType RANDOM_CONSTRAINT_LNS = BopOptimizerMethod_OptimizerType_RANDOM_CONSTRAINT_LNS;
  static const OptimizerType RANDOM_VARIABLE_LNS = BopOptimizerMethod_OptimizerType_RANDOM_VARIABLE_LNS;
  static const OptimizerType COMPLETE_LNS = BopOptimizerMethod_OptimizerType_COMPLETE_LNS;
  static const OptimizerType LP_FIRST_SOLUTION = BopOptimizerMethod_OptimizerType_LP_FIRST_SOLUTION;
  static const OptimizerType OBJECTIVE_FIRST_SOLUTION = BopOptimizerMethod_OptimizerType_OBJECTIVE_FIRST_SOLUTION;
  static const OptimizerType USER_GUIDED_FIRST_SOLUTION = BopOptimizerMethod_OptimizerType_USER_GUIDED_FIRST_SOLUTION;
  static const OptimizerType RANDOM_CONSTRAINT_LNS_GUIDED_BY_LP = BopOptimizerMethod_OptimizerType_RANDOM_CONSTRAINT_LNS_GUIDED_BY_LP;
  static const OptimizerType RANDOM_VARIABLE_LNS_GUIDED_BY_LP = BopOptimizerMethod_OptimizerType_RANDOM_VARIABLE_LNS_GUIDED_BY_LP;
  static const OptimizerType RELATION_GRAPH_LNS = BopOptimizerMethod_OptimizerType_RELATION_GRAPH_LNS;
  static const OptimizerType RELATION_GRAPH_LNS_GUIDED_BY_LP = BopOptimizerMethod_OptimizerType_RELATION_GRAPH_LNS_GUIDED_BY_LP;
  ...
  inline ::operations_research::bop::BopOptimizerMethod_OptimizerType type() const;
  inline void set_type(::operations_research::bop::BopOptimizerMethod_OptimizerType value);
...
class BopSolverOptimizerSet : public ::google::protobuf::Message {
 public:
  ...
  BopSolverOptimizerSet* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  ...
  inline const ::operations_research::bop::BopOptimizerMethod& methods(int index) const;
  inline ::operations_research::bop::BopOptimizerMethod* mutable_methods(int index);
  inline ::operations_research::bop::BopOptimizerMethod* add_methods();
...
class BopParameters : public ::google::protobuf::Message {
 public:
  BopParameters();
  ...
  static const ThreadSynchronizationType NO_SYNCHRONIZATION = BopParameters_ThreadSynchronizationType_NO_SYNCHRONIZATION;
  static const ThreadSynchronizationType SYNCHRONIZE_ALL = BopParameters_ThreadSynchronizationType_SYNCHRONIZE_ALL;
  static const ThreadSynchronizationType SYNCHRONIZE_ON_RIGHT = BopParameters_ThreadSynchronizationType_SYNCHRONIZE_ON_RIGHT;
  ...
  inline bool has_lp_max_deterministic_time() const;
  inline void clear_lp_max_deterministic_time();
  static const int kLpMaxDeterministicTimeFieldNumber = 37;
  inline double lp_max_deterministic_time() const;
  inline void set_lp_max_deterministic_time(double value);

  // optional int32 max_number_of_consecutive_failing_optimizer_calls = 35;
  inline bool has_max_number_of_consecutive_failing_optimizer_calls() const;
  inline void clear_max_number_of_consecutive_failing_optimizer_calls();
  static const int kMaxNumberOfConsecutiveFailingOptimizerCallsFieldNumber = 35;
  inline ::google::protobuf::int32 max_number_of_consecutive_failing_optimizer_calls() const;
  inline void set_max_number_of_consecutive_failing_optimizer_calls(::google::protobuf::int32 value);

  // optional double relative_gap_limit = 28 [default = 0.0001];
  inline bool has_relative_gap_limit() const;
  inline void clear_relative_gap_limit();
  static const int kRelativeGapLimitFieldNumber = 28;
  inline double relative_gap_limit() const;
  inline void set_relative_gap_limit(double value);

  // optional int32 max_num_decisions_in_ls = 2 [default = 4];
  inline bool has_max_num_decisions_in_ls() const;
  inline void clear_max_num_decisions_in_ls();
  static const int kMaxNumDecisionsInLsFieldNumber = 2;
  inline ::google::protobuf::int32 max_num_decisions_in_ls() const;
  inline void set_max_num_decisions_in_ls(::google::protobuf::int32 value);

  // optional int32 max_num_broken_constraints_in_ls = 38 [default = 2147483647];
  inline bool has_max_num_broken_constraints_in_ls() const;
  inline void clear_max_num_broken_constraints_in_ls();
  static const int kMaxNumBrokenConstraintsInLsFieldNumber = 38;
  inline ::google::protobuf::int32 max_num_broken_constraints_in_ls() const;
  inline void set_max_num_broken_constraints_in_ls(::google::protobuf::int32 value);
  ...
  inline bool has_compute_estimated_impact() const;
  inline void clear_compute_estimated_impact();
  static const int kComputeEstimatedImpactFieldNumber = 3;
  inline bool compute_estimated_impact() const;
  inline void set_compute_estimated_impact(bool value);

  // optional bool prune_search_tree = 4 [default = false];
  inline bool has_prune_search_tree() const;
  inline void clear_prune_search_tree();
  static const int kPruneSearchTreeFieldNumber = 4;
  inline bool prune_search_tree() const;
  inline void set_prune_search_tree(bool value);

  // optional bool sort_constraints_by_num_terms = 5 [default = false];
  inline bool has_sort_constraints_by_num_terms() const;
  inline void clear_sort_constraints_by_num_terms();
  static const int kSortConstraintsByNumTermsFieldNumber = 5;
  inline bool sort_constraints_by_num_terms() const;
  inline void set_sort_constraints_by_num_terms(bool value);

  // optional bool use_random_lns = 6 [default = true];
  inline bool has_use_random_lns() const;
  inline void clear_use_random_lns();
  static const int kUseRandomLnsFieldNumber = 6;
  inline bool use_random_lns() const;
  inline void set_use_random_lns(bool value);
  ...
  inline bool has_num_relaxed_vars() const;
  inline void clear_num_relaxed_vars();
  static const int kNumRelaxedVarsFieldNumber = 8;
  inline ::google::protobuf::int32 num_relaxed_vars() const;
  inline void set_num_relaxed_vars(::google::protobuf::int32 value);

  // optional int32 max_number_of_conflicts_in_random_lns = 9 [default = 2500];
  inline bool has_max_number_of_conflicts_in_random_lns() const;
  inline void clear_max_number_of_conflicts_in_random_lns();
  static const int kMaxNumberOfConflictsInRandomLnsFieldNumber = 9;
  inline ::google::protobuf::int32 max_number_of_conflicts_in_random_lns() const;
  inline void set_max_number_of_conflicts_in_random_lns(::google::protobuf::int32 value);

  // optional int32 num_random_lns_tries = 10 [default = 1];
  inline bool has_num_random_lns_tries() const;
  inline void clear_num_random_lns_tries();
  static const int kNumRandomLnsTriesFieldNumber = 10;
  inline ::google::protobuf::int32 num_random_lns_tries() const;
  inline void set_num_random_lns_tries(::google::protobuf::int32 value);

  // optional int64 max_number_of_backtracks_in_ls = 11 [default = 100000000];
  inline bool has_max_number_of_backtracks_in_ls() const;
  inline void clear_max_number_of_backtracks_in_ls();
  static const int kMaxNumberOfBacktracksInLsFieldNumber = 11;
  inline ::google::protobuf::int64 max_number_of_backtracks_in_ls() const;
  inline void set_max_number_of_backtracks_in_ls(::google::protobuf::int64 value);

  // optional bool use_lp_lns = 12 [default = true];
  inline bool has_use_lp_lns() const;
  inline void clear_use_lp_lns();
  static const int kUseLpLnsFieldNumber = 12;
  inline bool use_lp_lns() const;
  inline void set_use_lp_lns(bool value);

  // optional bool use_sat_to_choose_lns_neighbourhood = 15 [default = true];
  inline bool has_use_sat_to_choose_lns_neighbourhood() const;
  inline void clear_use_sat_to_choose_lns_neighbourhood();
  static const int kUseSatToChooseLnsNeighbourhoodFieldNumber = 15;
  inline bool use_sat_to_choose_lns_neighbourhood() const;
  inline void set_use_sat_to_choose_lns_neighbourhood(bool value);

  // optional int32 max_number_of_conflicts_for_quick_check = 16 [default = 10];
  inline bool has_max_number_of_conflicts_for_quick_check() const;
  inline void clear_max_number_of_conflicts_for_quick_check();
  static const int kMaxNumberOfConflictsForQuickCheckFieldNumber = 16;
  inline ::google::protobuf::int32 max_number_of_conflicts_for_quick_check() const;
  inline void set_max_number_of_conflicts_for_quick_check(::google::protobuf::int32 value);

  // optional bool use_symmetry = 17 [default = false];
  inline bool has_use_symmetry() const;
  inline void clear_use_symmetry();
  static const int kUseSymmetryFieldNumber = 17;
  inline bool use_symmetry() const;
  inline void set_use_symmetry(bool value);

  // optional int32 max_number_of_conflicts_in_random_solution_generation = 20 [default = 500];
  inline bool has_max_number_of_conflicts_in_random_solution_generation() const;
  inline void clear_max_number_of_conflicts_in_random_solution_generation();
  static const int kMaxNumberOfConflictsInRandomSolutionGenerationFieldNumber = 20;
  inline ::google::protobuf::int32 max_number_of_conflicts_in_random_solution_generation() const;
  inline void set_max_number_of_conflicts_in_random_solution_generation(::google::protobuf::int32 value);

  // optional int64 max_number_of_explored_assignments_per_try_in_ls = 21 [default = 10000];
  inline bool has_max_number_of_explored_assignments_per_try_in_ls() const;
  inline void clear_max_number_of_explored_assignments_per_try_in_ls();
  static const int kMaxNumberOfExploredAssignmentsPerTryInLsFieldNumber = 21;
  inline ::google::protobuf::int64 max_number_of_explored_assignments_per_try_in_ls() const;
  inline void set_max_number_of_explored_assignments_per_try_in_ls(::google::protobuf::int64 value);

  // optional bool use_transposition_table_in_ls = 22 [default = true];
  inline bool has_use_transposition_table_in_ls() const;
  inline void clear_use_transposition_table_in_ls();
  static const int kUseTranspositionTableInLsFieldNumber = 22;
  inline bool use_transposition_table_in_ls() const;
  inline void set_use_transposition_table_in_ls(bool value);

  // optional bool use_learned_binary_clauses_in_lp = 23 [default = true];
  inline bool has_use_learned_binary_clauses_in_lp() const;
  inline void clear_use_learned_binary_clauses_in_lp();
  static const int kUseLearnedBinaryClausesInLpFieldNumber = 23;
  inline bool use_learned_binary_clauses_in_lp() const;
  inline void set_use_learned_binary_clauses_in_lp(bool value);

  // optional int32 number_of_solvers = 24 [default = 1];
  inline bool has_number_of_solvers() const;
  inline void clear_number_of_solvers();
  static const int kNumberOfSolversFieldNumber = 24;
  inline ::google::protobuf::int32 number_of_solvers() const;
  inline void set_number_of_solvers(::google::protobuf::int32 value);
  ...
  inline bool has_synchronization_type() const;
  inline void clear_synchronization_type();
  static const int kSynchronizationTypeFieldNumber = 25;
  inline ::operations_research::bop::BopParameters_ThreadSynchronizationType synchronization_type() const;
  inline void set_synchronization_type(::operations_research::bop::BopParameters_ThreadSynchronizationType value);

  // repeated .operations_research.bop.BopSolverOptimizerSet solver_optimizer_sets = 26;
  inline int solver_optimizer_sets_size() const;
  inline void clear_solver_optimizer_sets();
  static const int kSolverOptimizerSetsFieldNumber = 26;
  inline const ::operations_research::bop::BopSolverOptimizerSet& solver_optimizer_sets(int index) const;
  inline ::operations_research::bop::BopSolverOptimizerSet* mutable_solver_optimizer_sets(int index);
  inline ::operations_research::bop::BopSolverOptimizerSet* add_solver_optimizer_sets();
  ...
  inline bool has_default_solver_optimizer_sets() const;
  inline void clear_default_solver_optimizer_sets();
  static const int kDefaultSolverOptimizerSetsFieldNumber = 33;
  inline const ::std::string& default_solver_optimizer_sets() const;
  inline void set_default_solver_optimizer_sets(const ::std::string& value);
  inline void set_default_solver_optimizer_sets(const char* value);
  inline void set_default_solver_optimizer_sets(const char* value, size_t size);
  inline ::std::string* mutable_default_solver_optimizer_sets();
  inline ::std::string* release_default_solver_optimizer_sets();
  inline void set_allocated_default_solver_optimizer_sets(::std::string* default_solver_optimizer_sets);

  // optional bool use_lp_strong_branching = 29 [default = false];
  inline bool has_use_lp_strong_branching() const;
  inline void clear_use_lp_strong_branching();
  static const int kUseLpStrongBranchingFieldNumber = 29;
  inline bool use_lp_strong_branching() const;
  inline void set_use_lp_strong_branching(bool value);

  // optional int32 decomposer_num_variables_threshold = 30 [default = 50];
  inline bool has_decomposer_num_variables_threshold() const;
  inline void clear_decomposer_num_variables_threshold();
  static const int kDecomposerNumVariablesThresholdFieldNumber = 30;
  inline ::google::protobuf::int32 decomposer_num_variables_threshold() const;
  inline void set_decomposer_num_variables_threshold(::google::protobuf::int32 value);

  // optional int32 num_bop_solvers_used_by_decomposition = 31 [default = 1];
  inline bool has_num_bop_solvers_used_by_decomposition() const;
  inline void clear_num_bop_solvers_used_by_decomposition();
  static const int kNumBopSolversUsedByDecompositionFieldNumber = 31;
  inline ::google::protobuf::int32 num_bop_solvers_used_by_decomposition() const;
  inline void set_num_bop_solvers_used_by_decomposition(::google::protobuf::int32 value);

  // optional double decomposed_problem_min_time_in_seconds = 36 [default = 0];
  inline bool has_decomposed_problem_min_time_in_seconds() const;
  inline void clear_decomposed_problem_min_time_in_seconds();
  static const int kDecomposedProblemMinTimeInSecondsFieldNumber = 36;
  inline double decomposed_problem_min_time_in_seconds() const;
  inline void set_decomposed_problem_min_time_in_seconds(double value);

  // optional int32 guided_sat_conflicts_chunk = 34 [default = 1000];
  inline bool has_guided_sat_conflicts_chunk() const;
  inline void clear_guided_sat_conflicts_chunk();
  static const int kGuidedSatConflictsChunkFieldNumber = 34;
  inline ::google::protobuf::int32 guided_sat_conflicts_chunk() const;
  inline void set_guided_sat_conflicts_chunk(::google::protobuf::int32 value);
 ...
 private:
  ...
  ::std::string* default_solver_optimizer_sets_;
...
inline const ::std::string& BopParameters::default_solver_optimizer_sets() const {
  ...
  return *default_solver_optimizer_sets_;
}
inline void BopParameters::set_default_solver_optimizer_sets(const ::std::string& value) {
  set_has_default_solver_optimizer_sets();
  if (default_solver_optimizer_sets_ == _default_default_solver_optimizer_sets_) {
    default_solver_optimizer_sets_ = new ::std::string;
  }
  default_solver_optimizer_sets_->assign(value);
...
inline void BopParameters::set_default_solver_optimizer_sets(const char* value, size_t size) {
  ...
  default_solver_optimizer_sets_->assign(reinterpret_cast<const char*>(value), size);
...
inline ::std::string* BopParameters::mutable_default_solver_optimizer_sets() {
  set_has_default_solver_optimizer_sets();
  if (default_solver_optimizer_sets_ == _default_default_solver_optimizer_sets_) {
    default_solver_optimizer_sets_ = new ::std::string(*_default_default_solver_optimizer_sets_);
  }
...
inline ::std::string* BopParameters::release_default_solver_optimizer_sets() {
  ...
  if (default_solver_optimizer_sets_ == _default_default_solver_optimizer_sets_) {
    ...
    ::std::string* temp = default_solver_optimizer_sets_;
...
inline void BopParameters::set_allocated_default_solver_optimizer_sets(::std::string* default_solver_optimizer_sets) {
  ...
  if (default_solver_optimizer_sets) {
    set_has_default_solver_optimizer_sets();
    default_solver_optimizer_sets_ = default_solver_optimizer_sets;
  } else {
    clear_has_default_solver_optimizer_sets();
    default_solver_optimizer_sets_ = const_cast< ::std::string*>(_default_default_solver_optimizer_sets_);
  }
