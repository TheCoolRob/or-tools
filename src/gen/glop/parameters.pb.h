...
#ifndef PROTOBUF_glop_2fparameters_2eproto__INCLUDED
#define PROTOBUF_glop_2fparameters_2eproto__INCLUDED
...
class GlopParameters : public ::google::protobuf::Message {
 public:
  GlopParameters();
  ...
  static const SolverBehavior ALWAYS_DO = GlopParameters_SolverBehavior_ALWAYS_DO;
  static const SolverBehavior NEVER_DO = GlopParameters_SolverBehavior_NEVER_DO;
  static const SolverBehavior LET_SOLVER_DECIDE = GlopParameters_SolverBehavior_LET_SOLVER_DECIDE;
  ...
  static const PricingRule DANTZIG = GlopParameters_PricingRule_DANTZIG;
  static const PricingRule STEEPEST_EDGE = GlopParameters_PricingRule_STEEPEST_EDGE;
  static const PricingRule DEVEX = GlopParameters_PricingRule_DEVEX;
  ...
  static const InitialBasisHeuristic NONE = GlopParameters_InitialBasisHeuristic_NONE;
  static const InitialBasisHeuristic BIXBY = GlopParameters_InitialBasisHeuristic_BIXBY;
  static const InitialBasisHeuristic TRIANGULAR = GlopParameters_InitialBasisHeuristic_TRIANGULAR;
  ...
  inline bool has_feasibility_rule() const;
  inline void clear_feasibility_rule();
  static const int kFeasibilityRuleFieldNumber = 1;
  inline ::operations_research::glop::GlopParameters_PricingRule feasibility_rule() const;
  inline void set_feasibility_rule(::operations_research::glop::GlopParameters_PricingRule value);

  // optional .operations_research.glop.GlopParameters.PricingRule optimization_rule = 2 [default = STEEPEST_EDGE];
  inline bool has_optimization_rule() const;
  inline void clear_optimization_rule();
  static const int kOptimizationRuleFieldNumber = 2;
  inline ::operations_research::glop::GlopParameters_PricingRule optimization_rule() const;
  inline void set_optimization_rule(::operations_research::glop::GlopParameters_PricingRule value);

  // optional bool normalize_using_column_norm = 4 [default = true];
  inline bool has_normalize_using_column_norm() const;
  inline void clear_normalize_using_column_norm();
  static const int kNormalizeUsingColumnNormFieldNumber = 4;
  inline bool normalize_using_column_norm() const;
  inline void set_normalize_using_column_norm(bool value);

  // optional bool use_nested_pricing = 5 [default = true];
  inline bool has_use_nested_pricing() const;
  inline void clear_use_nested_pricing();
  static const int kUseNestedPricingFieldNumber = 5;
  inline bool use_nested_pricing() const;
  inline void set_use_nested_pricing(bool value);

  // optional double refactorization_threshold = 6 [default = 1e-008];
  inline bool has_refactorization_threshold() const;
  inline void clear_refactorization_threshold();
  static const int kRefactorizationThresholdFieldNumber = 6;
  inline double refactorization_threshold() const;
  inline void set_refactorization_threshold(double value);

  // optional double recompute_reduced_costs_threshold = 8 [default = 1e-008];
  inline bool has_recompute_reduced_costs_threshold() const;
  inline void clear_recompute_reduced_costs_threshold();
  static const int kRecomputeReducedCostsThresholdFieldNumber = 8;
  inline double recompute_reduced_costs_threshold() const;
  inline void set_recompute_reduced_costs_threshold(double value);

  // optional double recompute_edges_norm_threshold = 9 [default = 100];
  inline bool has_recompute_edges_norm_threshold() const;
  inline void clear_recompute_edges_norm_threshold();
  static const int kRecomputeEdgesNormThresholdFieldNumber = 9;
  inline double recompute_edges_norm_threshold() const;
  inline void set_recompute_edges_norm_threshold(double value);

  // optional double primal_feasibility_tolerance = 10 [default = 1e-008];
  inline bool has_primal_feasibility_tolerance() const;
  inline void clear_primal_feasibility_tolerance();
  static const int kPrimalFeasibilityToleranceFieldNumber = 10;
  inline double primal_feasibility_tolerance() const;
  inline void set_primal_feasibility_tolerance(double value);

  // optional double dual_feasibility_tolerance = 11 [default = 1e-010];
  inline bool has_dual_feasibility_tolerance() const;
  inline void clear_dual_feasibility_tolerance();
  static const int kDualFeasibilityToleranceFieldNumber = 11;
  inline double dual_feasibility_tolerance() const;
  inline void set_dual_feasibility_tolerance(double value);

  // optional double ratio_test_zero_threshold = 12 [default = 1e-009];
  inline bool has_ratio_test_zero_threshold() const;
  inline void clear_ratio_test_zero_threshold();
  static const int kRatioTestZeroThresholdFieldNumber = 12;
  inline double ratio_test_zero_threshold() const;
  inline void set_ratio_test_zero_threshold(double value);

  // optional double harris_tolerance_ratio = 13 [default = 0.5];
  inline bool has_harris_tolerance_ratio() const;
  inline void clear_harris_tolerance_ratio();
  static const int kHarrisToleranceRatioFieldNumber = 13;
  inline double harris_tolerance_ratio() const;
  inline void set_harris_tolerance_ratio(double value);

  // optional double small_pivot_threshold = 14 [default = 1e-006];
  inline bool has_small_pivot_threshold() const;
  inline void clear_small_pivot_threshold();
  static const int kSmallPivotThresholdFieldNumber = 14;
  inline double small_pivot_threshold() const;
  inline void set_small_pivot_threshold(double value);

  // optional double minimum_acceptable_pivot = 15 [default = 1e-006];
  inline bool has_minimum_acceptable_pivot() const;
  inline void clear_minimum_acceptable_pivot();
  static const int kMinimumAcceptablePivotFieldNumber = 15;
  inline double minimum_acceptable_pivot() const;
  inline void set_minimum_acceptable_pivot(double value);

  // optional bool use_scaling = 16 [default = true];
  inline bool has_use_scaling() const;
  inline void clear_use_scaling();
  static const int kUseScalingFieldNumber = 16;
  inline bool use_scaling() const;
  inline void set_use_scaling(bool value);

  // optional .operations_research.glop.GlopParameters.InitialBasisHeuristic initial_basis = 17 [default = TRIANGULAR];
  inline bool has_initial_basis() const;
  inline void clear_initial_basis();
  static const int kInitialBasisFieldNumber = 17;
  inline ::operations_research::glop::GlopParameters_InitialBasisHeuristic initial_basis() const;
  inline void set_initial_basis(::operations_research::glop::GlopParameters_InitialBasisHeuristic value);

  // optional bool use_transposed_matrix = 18 [default = true];
  inline bool has_use_transposed_matrix() const;
  inline void clear_use_transposed_matrix();
  static const int kUseTransposedMatrixFieldNumber = 18;
  inline bool use_transposed_matrix() const;
  inline void set_use_transposed_matrix(bool value);

  // optional int32 basis_refactorization_period = 19 [default = 64];
  inline bool has_basis_refactorization_period() const;
  inline void clear_basis_refactorization_period();
  static const int kBasisRefactorizationPeriodFieldNumber = 19;
  inline ::google::protobuf::int32 basis_refactorization_period() const;
  inline void set_basis_refactorization_period(::google::protobuf::int32 value);

  // optional .operations_research.glop.GlopParameters.SolverBehavior solve_dual_problem = 20 [default = LET_SOLVER_DECIDE];
  inline bool has_solve_dual_problem() const;
  inline void clear_solve_dual_problem();
  static const int kSolveDualProblemFieldNumber = 20;
  inline ::operations_research::glop::GlopParameters_SolverBehavior solve_dual_problem() const;
  inline void set_solve_dual_problem(::operations_research::glop::GlopParameters_SolverBehavior value);

  // optional double dualizer_threshold = 21 [default = 1.5];
  inline bool has_dualizer_threshold() const;
  inline void clear_dualizer_threshold();
  static const int kDualizerThresholdFieldNumber = 21;
  inline double dualizer_threshold() const;
  inline void set_dualizer_threshold(double value);

  // optional double solution_feasibility_tolerance = 22 [default = 1e-006];
  inline bool has_solution_feasibility_tolerance() const;
  inline void clear_solution_feasibility_tolerance();
  static const int kSolutionFeasibilityToleranceFieldNumber = 22;
  inline double solution_feasibility_tolerance() const;
  inline void set_solution_feasibility_tolerance(double value);

  // optional bool provide_strong_optimal_guarantee = 24 [default = true];
  inline bool has_provide_strong_optimal_guarantee() const;
  inline void clear_provide_strong_optimal_guarantee();
  static const int kProvideStrongOptimalGuaranteeFieldNumber = 24;
  inline bool provide_strong_optimal_guarantee() const;
  inline void set_provide_strong_optimal_guarantee(bool value);

  // optional double lu_factorization_pivot_threshold = 25 [default = 0.01];
  inline bool has_lu_factorization_pivot_threshold() const;
  inline void clear_lu_factorization_pivot_threshold();
  static const int kLuFactorizationPivotThresholdFieldNumber = 25;
  inline double lu_factorization_pivot_threshold() const;
  inline void set_lu_factorization_pivot_threshold(double value);
  ...
  inline bool has_max_deterministic_time() const;
  inline void clear_max_deterministic_time();
  static const int kMaxDeterministicTimeFieldNumber = 45;
  inline double max_deterministic_time() const;
  inline void set_max_deterministic_time(double value);

  // optional int64 max_number_of_iterations = 27 [default = -1];
  inline bool has_max_number_of_iterations() const;
  inline void clear_max_number_of_iterations();
  static const int kMaxNumberOfIterationsFieldNumber = 27;
  inline ::google::protobuf::int64 max_number_of_iterations() const;
  inline void set_max_number_of_iterations(::google::protobuf::int64 value);

  // optional int32 markowitz_zlatev_parameter = 29 [default = 3];
  inline bool has_markowitz_zlatev_parameter() const;
  inline void clear_markowitz_zlatev_parameter();
  static const int kMarkowitzZlatevParameterFieldNumber = 29;
  inline ::google::protobuf::int32 markowitz_zlatev_parameter() const;
  inline void set_markowitz_zlatev_parameter(::google::protobuf::int32 value);

  // optional double markowitz_singularity_threshold = 30 [default = 1e-015];
  inline bool has_markowitz_singularity_threshold() const;
  inline void clear_markowitz_singularity_threshold();
  static const int kMarkowitzSingularityThresholdFieldNumber = 30;
  inline double markowitz_singularity_threshold() const;
  inline void set_markowitz_singularity_threshold(double value);

  // optional bool use_dual_simplex = 31 [default = false];
  inline bool has_use_dual_simplex() const;
  inline void clear_use_dual_simplex();
  static const int kUseDualSimplexFieldNumber = 31;
  inline bool use_dual_simplex() const;
  inline void set_use_dual_simplex(bool value);

  // optional bool allow_simplex_algorithm_change = 32 [default = false];
  inline bool has_allow_simplex_algorithm_change() const;
  inline void clear_allow_simplex_algorithm_change();
  static const int kAllowSimplexAlgorithmChangeFieldNumber = 32;
  inline bool allow_simplex_algorithm_change() const;
  inline void set_allow_simplex_algorithm_change(bool value);

  // optional int32 devex_weights_reset_period = 33 [default = 150];
  inline bool has_devex_weights_reset_period() const;
  inline void clear_devex_weights_reset_period();
  static const int kDevexWeightsResetPeriodFieldNumber = 33;
  inline ::google::protobuf::int32 devex_weights_reset_period() const;
  inline void set_devex_weights_reset_period(::google::protobuf::int32 value);

  // optional bool use_preprocessing = 34 [default = true];
  inline bool has_use_preprocessing() const;
  inline void clear_use_preprocessing();
  static const int kUsePreprocessingFieldNumber = 34;
  inline bool use_preprocessing() const;
  inline void set_use_preprocessing(bool value);

  // optional bool use_middle_product_form_update = 35 [default = true];
  inline bool has_use_middle_product_form_update() const;
  inline void clear_use_middle_product_form_update();
  static const int kUseMiddleProductFormUpdateFieldNumber = 35;
  inline bool use_middle_product_form_update() const;
  inline void set_use_middle_product_form_update(bool value);

  // optional bool initialize_devex_with_column_norms = 36 [default = true];
  inline bool has_initialize_devex_with_column_norms() const;
  inline void clear_initialize_devex_with_column_norms();
  static const int kInitializeDevexWithColumnNormsFieldNumber = 36;
  inline bool initialize_devex_with_column_norms() const;
  inline void set_initialize_devex_with_column_norms(bool value);

  // optional bool exploit_singleton_column_in_initial_basis = 37 [default = true];
  inline bool has_exploit_singleton_column_in_initial_basis() const;
  inline void clear_exploit_singleton_column_in_initial_basis();
  static const int kExploitSingletonColumnInInitialBasisFieldNumber = 37;
  inline bool exploit_singleton_column_in_initial_basis() const;
  inline void set_exploit_singleton_column_in_initial_basis(bool value);

  // optional double dual_small_pivot_threshold = 38 [default = 0.0001];
  inline bool has_dual_small_pivot_threshold() const;
  inline void clear_dual_small_pivot_threshold();
  static const int kDualSmallPivotThresholdFieldNumber = 38;
  inline double dual_small_pivot_threshold() const;
  inline void set_dual_small_pivot_threshold(double value);

  // optional double preprocessor_zero_tolerance = 39 [default = 1e-009];
  inline bool has_preprocessor_zero_tolerance() const;
  inline void clear_preprocessor_zero_tolerance();
  static const int kPreprocessorZeroToleranceFieldNumber = 39;
  inline double preprocessor_zero_tolerance() const;
  inline void set_preprocessor_zero_tolerance(double value);

  // optional double objective_lower_limit = 40 [default = -inf];
  inline bool has_objective_lower_limit() const;
  inline void clear_objective_lower_limit();
  static const int kObjectiveLowerLimitFieldNumber = 40;
  inline double objective_lower_limit() const;
  inline void set_objective_lower_limit(double value);

  // optional double objective_upper_limit = 41 [default = inf];
  inline bool has_objective_upper_limit() const;
  inline void clear_objective_upper_limit();
  static const int kObjectiveUpperLimitFieldNumber = 41;
  inline double objective_upper_limit() const;
  inline void set_objective_upper_limit(double value);

  // optional double degenerate_ministep_factor = 42 [default = 0.01];
  inline bool has_degenerate_ministep_factor() const;
  inline void clear_degenerate_ministep_factor();
  static const int kDegenerateMinistepFactorFieldNumber = 42;
  inline double degenerate_ministep_factor() const;
  inline void set_degenerate_ministep_factor(double value);
  ...
  inline bool has_num_omp_threads() const;
  inline void clear_num_omp_threads();
  static const int kNumOmpThreadsFieldNumber = 44;
  inline ::google::protobuf::int32 num_omp_threads() const;
  inline void set_num_omp_threads(::google::protobuf::int32 value);

  // @@protoc_insertion_point(class_scope:operations_research.glop.GlopParameters)
 private:
  inline void set_has_feasibility_rule();
  inline void clear_has_feasibility_rule();
  inline void set_has_optimization_rule();
  inline void clear_has_optimization_rule();
  inline void set_has_normalize_using_column_norm();
  inline void clear_has_normalize_using_column_norm();
  inline void set_has_use_nested_pricing();
  inline void clear_has_use_nested_pricing();
  inline void set_has_refactorization_threshold();
  inline void clear_has_refactorization_threshold();
  inline void set_has_recompute_reduced_costs_threshold();
  inline void clear_has_recompute_reduced_costs_threshold();
  inline void set_has_recompute_edges_norm_threshold();
  inline void clear_has_recompute_edges_norm_threshold();
  inline void set_has_primal_feasibility_tolerance();
  inline void clear_has_primal_feasibility_tolerance();
  inline void set_has_dual_feasibility_tolerance();
  inline void clear_has_dual_feasibility_tolerance();
  inline void set_has_ratio_test_zero_threshold();
  inline void clear_has_ratio_test_zero_threshold();
  inline void set_has_harris_tolerance_ratio();
  inline void clear_has_harris_tolerance_ratio();
  ...
  inline void clear_has_minimum_acceptable_pivot();
  inline void set_has_use_scaling();
  inline void clear_has_use_scaling();
  inline void set_has_initial_basis();
  inline void clear_has_initial_basis();
  inline void set_has_use_transposed_matrix();
  inline void clear_has_use_transposed_matrix();
  inline void set_has_basis_refactorization_period();
  inline void clear_has_basis_refactorization_period();
  inline void set_has_solve_dual_problem();
  inline void clear_has_solve_dual_problem();
  inline void set_has_dualizer_threshold();
  inline void clear_has_dualizer_threshold();
  inline void set_has_solution_feasibility_tolerance();
  inline void clear_has_solution_feasibility_tolerance();
  inline void set_has_provide_strong_optimal_guarantee();
  inline void clear_has_provide_strong_optimal_guarantee();
  inline void set_has_lu_factorization_pivot_threshold();
  inline void clear_has_lu_factorization_pivot_threshold();
  ...
  inline void set_has_max_number_of_iterations();
  inline void clear_has_max_number_of_iterations();
  inline void set_has_markowitz_zlatev_parameter();
  inline void clear_has_markowitz_zlatev_parameter();
  inline void set_has_markowitz_singularity_threshold();
  inline void clear_has_markowitz_singularity_threshold();
  inline void set_has_use_dual_simplex();
  inline void clear_has_use_dual_simplex();
  inline void set_has_allow_simplex_algorithm_change();
  inline void clear_has_allow_simplex_algorithm_change();
  inline void set_has_devex_weights_reset_period();
  inline void clear_has_devex_weights_reset_period();
  inline void set_has_use_preprocessing();
  ...
  inline void set_has_initialize_devex_with_column_norms();
  inline void clear_has_initialize_devex_with_column_norms();
  inline void set_has_exploit_singleton_column_in_initial_basis();
  inline void clear_has_exploit_singleton_column_in_initial_basis();
  inline void set_has_dual_small_pivot_threshold();
  inline void clear_has_dual_small_pivot_threshold();
  inline void set_has_preprocessor_zero_tolerance();
  inline void clear_has_preprocessor_zero_tolerance();
  inline void set_has_objective_lower_limit();
  inline void clear_has_objective_lower_limit();
  inline void set_has_objective_upper_limit();
  inline void clear_has_objective_upper_limit();
  inline void set_has_degenerate_ministep_factor();
  inline void clear_has_degenerate_ministep_factor();
  inline void set_has_random_seed();
  inline void clear_has_random_seed();
  inline void set_has_num_omp_threads();
  inline void clear_has_num_omp_threads();
  ...
  friend void  protobuf_AddDesc_glop_2fparameters_2eproto();
  friend void protobuf_AssignDesc_glop_2fparameters_2eproto();
  friend void protobuf_ShutdownFile_glop_2fparameters_2eproto();

  void InitAsDefaultInstance();
  static GlopParameters* default_instance_;
};
// ===================================================================
...
#endif  // PROTOBUF_glop_2fparameters_2eproto__INCLUDED
