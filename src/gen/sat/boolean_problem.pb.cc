...
void protobuf_AssignDesc_sat_2fboolean_5fproblem_2eproto() {
  ...
  static const int LinearBooleanProblem_offsets_[7] = {
...
void protobuf_AddDesc_sat_2fboolean_5fproblem_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "\n\021BooleanAssignment\022\020\n\010literals\030\001 \003(\005\"\250\002"
    "\n\024LinearBooleanProblem\022\016\n\004name\030\001 \001(\t:\000\022\025"
    "\n\rnum_variables\030\003 \001(\005\022A\n\013constraints\030\004 \003"
    "(\0132,.operations_research.LinearBooleanCo"
    "nstraint\0227\n\tobjective\030\005 \001(\0132$.operations"
    "_research.LinearObjective\022\021\n\tvar_names\030\006"
    " \003(\t\022:\n\nassignment\030\007 \001(\0132&.operations_re"
    "search.BooleanAssignment\022\036\n\026original_num"
    "_variables\030\010 \001(\005", 616);
...
#define ZR_(first, last) do {                              \
  ...
  if (_has_bits_[0 / 32] & 107) {
    ZR_(num_variables_, original_num_variables_);
    if (has_name()) {
      if (name_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
        name_->clear();
      }
