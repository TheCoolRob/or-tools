...
class Arc : public ::google::protobuf::Message {
 public:
  ...
  inline bool has_tail_node_id() const;
  inline void clear_tail_node_id();
  static const int kTailNodeIdFieldNumber = 1;
  inline ::google::protobuf::int64 tail_node_id() const;
  inline void set_tail_node_id(::google::protobuf::int64 value);

  // optional int64 head_node_id = 2;
  inline bool has_head_node_id() const;
  inline void clear_head_node_id();
  static const int kHeadNodeIdFieldNumber = 2;
  inline ::google::protobuf::int64 head_node_id() const;
  inline void set_head_node_id(::google::protobuf::int64 value);
  ...
  inline bool has_unit_cost() const;
  inline void clear_unit_cost();
  static const int kUnitCostFieldNumber = 4;
  inline ::google::protobuf::int64 unit_cost() const;
  inline void set_unit_cost(::google::protobuf::int64 value);
...
class Node : public ::google::protobuf::Message {
 public:
  ...
  inline ::google::protobuf::int64 supply() const;
  inline void set_supply(::google::protobuf::int64 value);
...
class FlowModel : public ::google::protobuf::Message {
 public:
  FlowModel();
  virtual ~FlowModel();
  ...
  static const ProblemType LINEAR_SUM_ASSIGNMENT = FlowModel_ProblemType_LINEAR_SUM_ASSIGNMENT;
  static const ProblemType MAX_FLOW = FlowModel_ProblemType_MAX_FLOW;
  static const ProblemType MIN_COST_FLOW = FlowModel_ProblemType_MIN_COST_FLOW;
  ...
  inline const ::operations_research::Node& node(int index) const;
  inline ::operations_research::Node* mutable_node(int index);
  inline ::operations_research::Node* add_node();
  ...
  inline int arc_size() const;
  inline void clear_arc();
  static const int kArcFieldNumber = 2;
  inline const ::operations_research::Arc& arc(int index) const;
  inline ::operations_research::Arc* mutable_arc(int index);
  inline ::operations_research::Arc* add_arc();
  ...
  inline ::operations_research::FlowModel_ProblemType problem_type() const;
  inline void set_problem_type(::operations_research::FlowModel_ProblemType value);
